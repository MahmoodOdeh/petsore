pipeline {
    ...
    stages {
        ...
        stage('Install pytest') {
            steps {
                script {
                     bat 'call C:/Users/odehm/Desktop/repos/petsore/.venv/Scripts/pip.exe install pytest C:/Users/odehm/Desktop/repos/petsore/test/End_to_End.py  --html=${TEST_REPORTS}/report.html --self-contained-html'
                }
            }
        }
